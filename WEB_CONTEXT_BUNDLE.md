...
```json
{
  ...
  "attempts": [
    {
      "artifacts": [],
      "attempt_id": "attempt:um-ep-1054-erd-s-problem-1054-397acdf4-source-fidelity-01",
      "claims": [],
      "completed_at": null,
      "generator": "trusted-rolling-source-admission-v1",
      "inputs": [
        "problem-library/records/canonical-problems.jsonl",
        "https://www.unsolvedmath.com/problems/EP-1054"
      ],
      "lifecycle": "planned",
      "method": "discovery",
      "objective": "Close the source-fidelity obligation before attempting the frozen root statement.",
      "obligation_graph_id": "graph:um-ep-1054-erd-s-problem-1054-397acdf4-v1",
      "problem_contract_sha256": "4c98f6fd8cf0cd37501024c3b59f24f327eeccd395de2a56c2fac1e9c98a9ce9",
      "problem_id": "problem:um-ep-1054-erd-s-problem-1054-397acdf4",
      "route_id": "route:um-ep-1054-erd-s-problem-1054-397acdf4-source-fidelity",
  ...
  "obligation_graphs": [
    {
      "attempt_id": "attempt:um-ep-1054-erd-s-problem-1054-397acdf4-source-fidelity-01",
      "graph_id": "graph:um-ep-1054-erd-s-problem-1054-397acdf4-v1",
      "obligations": [
        {
          "dependencies": [
            "obligation:um-ep-1054-erd-s-problem-1054-397acdf4-statement-fidelity"
          ],
          "kind": "root_claim",
          "obligation_id": "obligation:um-ep-1054-erd-s-problem-1054-397acdf4-root",
          "statement": {
            "formal_declaration": null,
            "language": "en",
            "text": "Let $f(n)$ be the minimal integer $m$ such that $n$ is the sum of the $k$ smallest divisors of $m$ for some $k\\geq 1$. Is it true that $f(n)=o(n)$? Or is this true only for almost all $n$, and $\\limsup f(n)/n=\\infty$?"
          },
          "statement_sha256": "e6367017c8d00608b537e894a4ef3027efe45fea6e37b09c0d2ee0ed49513bc5"
        },
        {
          "dependencies": [],
          "kind": "definition",
          "obligation_id": "obligation:um-ep-1054-erd-s-problem-1054-397acdf4-statement-fidelity",
          "statement": {
            "formal_declaration": null,
            "language": "en",
      ...
      "root_obligation_id": "obligation:um-ep-1054-erd-s-problem-1054-397acdf4-root",
      "route_id": "route:um-ep-1054-erd-s-problem-1054-397acdf4-source-fidelity"
    }
  ],
  "problem_contract": {
    ...
    "sources": [
      {
        ...
        "source_record_id": "unsolvedmath-ep-1054-520d6ad17c16",
        "url": "https://www.unsolvedmath.com/problems/EP-1054"
      },
      {
        "retrieved_at": "2026-09-02T00:06:43Z",
